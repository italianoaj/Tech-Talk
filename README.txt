...
6 April 2018
	...
	For my final project of the class I have implemented node, express, mongodb, views, html, css, and js in order to create an online chat room for Hiram colege computer
...
I was only able to accomplish the sending of POST requests when Professor Oliphant had time to assist me.
